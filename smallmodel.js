webpackJsonp([20], {
    W7VP: function (e, i, n) {
      ...
      var a = {
          init: function (e) {
            this.initViewer(e), this.loadModels(), this.setView();
          },
          ...
          loadGlb: function () {
            for (
              var e = [
                  ...
                  { name: "Taxi", scale: 100 },
                  { name: "redCar", scale: 3 },
                  { name: "Sedan", scale: 100 },
                  { name: "PublicBus", scale: 100 },
                  { name: "xiaofangyuan", scale: 100 },
                  { name: "Cesium_Air", scale: 20, minHeight: 60 },
                  { name: "Helicopter", scale: 10 },
                  { name: "SubwayTrain", scale: 50 },
                  { name: "train", scale: 50 },
                  { name: "camera", scale: 100 },
                  { name: "leida", scale: 1 }
                ],
                i = 0,
                n = 0;
          ...
          loadGltf: function () {
            for (
              var e = [
                  { name: "building", scale: 1 },
                  { name: "fengche", scale: 100 },
                  { name: "police", scale: 100 },
                  { name: "man/walk", scale: 80 },
                  { name: "xiaofangche", scale: 30 },
                  { name: "police_car", scale: 100 },
                  { name: "weixin", scale: 0.2, minHeight: 50 }
                ],
                i = 0,
                n = 0;
              n < e.length;
          ...
          staticRenderFns: [
            function () {
              var e = this.$createElement,
                i = this._self._c || e;
              return i("div", { staticClass: "app-wrapp" }, [
                i("div", {
                  staticClass: "cesium-container",
                  attrs: { id: "cesium-container" }
                })
              ]);
            }
          ]
