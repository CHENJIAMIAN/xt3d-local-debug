export default class BaseGradientMaterial {
  constructor(color) {
  ...
  getValue(time, result = {}) {
    ...
    result.image = Cesium.Material.GradientImage;
    return result;
  }
  ...
  equals(other) {
    return (
      this === other ||
      (other instanceof BaseGradientMaterial &&
...
Cesium.Material._materialCache.addMaterial(Cesium.Material.GradientType, {
  ...
  translucent: function (_0x293b60) {
    return true;
  }
});
