    ...
    t93q: function(e, t, n) {
        ...
        var o = n("q+RB")
          , i = {
            ...
            onEnterRules: [{
                ...
                afterText: /^\s*\*\/$/,
                action: {
                    indentAction: o.a.IndentAction.IndentOutdent,
                    appendText: " * "
                }
            }, {
                beforeText: /^\s*\/\*\*(?!\/)([^\*]|\*(?!\/))*$/,
                action: {
                    indentAction: o.a.IndentAction.None,
                    appendText: " * "
                }
            }, {
                beforeText: /^(\t|(\ \ ))*\ \*(\ ([^\*]|\*(?!\/))*)?$/,
        ...
        var s = i
          , c = {
            ...
            escapes: r.escapes,
            digits: r.digits,
            octaldigits: r.octaldigits,
            binarydigits: r.binarydigits,
            hexdigits: r.hexdigits,
            regexpctl: r.regexpctl,
            regexpesc: r.regexpesc,
