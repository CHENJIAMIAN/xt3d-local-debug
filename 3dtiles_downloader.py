...
def getContents(contents, n):
    # print('getContents内部',contents);
    #下载content url里的东西
    if 'content' in n:
        c = n['content']
        print('getContents内部',c);
...
python 3dtiles_downloader.py -u http://211.149.185.229:8081/data/country_build/chengdu_ajust_clip/tileset.json -d D:\Desktop\3ddd
"""