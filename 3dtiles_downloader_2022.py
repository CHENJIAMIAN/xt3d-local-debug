...
""" 
可下载external tilesets（我称之为层级tilesets）

IKangXu/3dtilesdownloader: 下载在线3dtiles数据，可自指定多线程数，可分段下载，可指定位置下载。基于Python 3.7.0开发
...
python 3dtiles_downloader_2022.py -u http://211.149.185.229:8081/data/country_build/chengdu_ajust_clip/tileset.json -d D:\Desktop\3ddd  -t 10
"""